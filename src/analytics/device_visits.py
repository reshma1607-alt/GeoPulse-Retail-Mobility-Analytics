...
for _, store in stores.iterrows():
    ...
    store_visits["StoreID"] = store["StoreID"]
    store_visits["StoreName"] = store["StoreName"]
...
if results:
    ...
    print("Device store visit analysis completed.")
    print(result_df.head(10))

else:

    print("No device visits found within the catchment radius.")